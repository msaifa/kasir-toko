...
public class LPelanggan extends Fragment {
    ...
    public void event(){
        ...
        wExport.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DDialogExport dialogExport = new DDialogExport(getActivity(),"lpelanggan",q) ;
    ...
    public void loadData(String cari){
        ...
        AdapterLapPelanggan adapter = new AdapterLapPelanggan(array) ;
